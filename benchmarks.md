...
| `pure_scalar_algorithm_speed/rational_cross_difference_unit_divisor_composed_cold` | 625.27 ns | 622.38 ns - 628.75 ns | Computes a fresh wide-integer cross difference and divides it by negative one through general operations. |
| `pure_scalar_algorithm_speed/rational_cross_difference_unit_divisor_fused_cold` | 190.15 ns | 188.70 ns - 191.64 ns | Computes the same cross difference through the checked fused unit-divisor path. |
