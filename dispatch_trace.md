...
| `computable/inverse_trig/mid-domain` | `computable` | `atan` | `rough-small-prescaled` | 1 |
| `computable/inverse_trig/mid-domain` | `computable` | `atan` | `structural-small-prescaled` | 1 |
...
| `computable/inverse_trig_adversarial/acos_mid` | `computable` | `atan` | `structural-small-prescaled` | 1 |
...
| `real/div/div_const_product_sqrt` | `real` | `definitely_zero` | `rational-sign` | 10 |
...
| `real/inverse/inverse_generic` | `real` | `definitely_zero` | `rational-sign` | 3 |
