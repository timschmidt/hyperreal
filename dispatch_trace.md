...
| `computable/inverse_hyperbolic_adversarial/acosh_large` | `computable` | `acosh` | `exact-rational-at-least-two-direct-ln-sqrt` | 1 |
...
| `computable/inverse_hyperbolic_adversarial/acosh_two` | `computable` | `acosh` | `exact-rational-at-least-two-direct-ln-sqrt` | 1 |
| `computable/inverse_hyperbolic_adversarial/acosh_two` | `computable` | `constructor` | `one` | 1 |
| `computable/inverse_hyperbolic_adversarial/acosh_two` | `computable` | `constructor` | `rational-node` | 3 |
...
| `computable/inverse_hyperbolic_adversarial/acosh_two` | `computable` | `sqrt` | `generic-sqrt-node` | 3 |
...
| `real/div/rational_over_symbolic` | `computable` | `constructor` | `shared-constant-wrapper` | 2 |
...
| `real/div/rational_over_symbolic` | `real` | `definitely_zero` | `rational-sign` | 6 |
| `real/div/rational_over_symbolic` | `real` | `div` | `lhs-rational-symbolic-inverse` | 2 |
| `real/div/rational_over_symbolic` | `real` | `inverse_ref` | `exp` | 1 |
| `real/div/rational_over_symbolic` | `real` | `inverse_ref` | `pi` | 1 |
...
| `real/inverse_hyperbolic/sqrt` | `computable` | `constructor` | `asinh-near-zero-deferred` | 1 |
| `real/inverse_hyperbolic/sqrt` | `computable` | `constructor` | `one` | 2 |
| `real/inverse_hyperbolic/sqrt` | `computable` | `constructor` | `rational-node` | 1 |
| `real/inverse_hyperbolic/sqrt` | `computable` | `sqrt` | `generic-sqrt-node` | 1 |
| `real/inverse_hyperbolic/sqrt` | `real` | `asinh` | `near-zero-deferred-node` | 1 |
| `real/inverse_hyperbolic/sqrt` | `real` | `atanh` | `sqrt-half-asinh-one` | 1 |
| `real/inverse_hyperbolic/sqrt` | `real` | `best_sign` | `symbolic-or-rational` | 1 |
| `real/inverse_hyperbolic/sqrt` | `real` | `constructor` | `one` | 1 |
| `real/inverse_hyperbolic/sqrt` | `real` | `constructor` | `rational` | 2 |
| `real/inverse_hyperbolic/sqrt` | `real` | `definitely_zero` | `rational-sign` | 4 |
| `real/inverse_hyperbolic/sqrt` | `real` | `sqrt` | `rational-sqrt-special-form` | 1 |
...
| `real/pow/symbolic_negative_one` | `computable` | `constructor` | `shared-constant-wrapper` | 2 |
...
| `real/pow/symbolic_negative_one` | `real` | `definitely_zero` | `rational-sign` | 4 |
| `real/pow/symbolic_negative_one` | `real` | `inverse` | `exp` | 1 |
| `real/pow/symbolic_negative_one` | `real` | `inverse` | `pi` | 1 |
