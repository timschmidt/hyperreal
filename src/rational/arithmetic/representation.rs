...
const RETAINED_RELATIVE_F64_FILTER_SEEN: u32 = 1 << 30;
const RETAINED_RELATIVE_F64_FILTER_VIEW: u32 = 1 << 31;
const RETAINED_DYADIC_SHIFT_MASK: u32 =
    (RETAINED_RELATIVE_F64_FILTER_SEEN - 1) & !((1 << RETAINED_DYADIC_SHIFT_OFFSET) - 1);
